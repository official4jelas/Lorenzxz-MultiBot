...
const getMyAnimeListData = require('../library/getMyAnimeListData.js')
const filter = require('../library/filterContent');
const { ytdl } = require('../library/scrape/scrape-ytdl');
const path = require('path')
const { pathToFileURL } = require('url');
const puppeteer = require('puppeteer');
const { config, saveConfig } = require('../library/addbottoken');
const searchResults = {}

async function loadAllFeatures(bot) {
  const allFeaturesDir = path.join(__dirname, '../plugins/telegram');
...
`;
    ...
    ctx.replyWithPhoto(
        { url: 'https://files.catbox.moe/gwuoty.jpg' },
